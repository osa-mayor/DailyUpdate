# Model & Eval Signals (2026-05-23)

## 오늘의 요약
ByteDance와 Tencent의 특화 모델(Any-to-any, 번역)이 Hugging Face에서 주목받는 가운데, SWE-bench와 LiveCodeBench를 통해 소프트웨어 엔지니어링 및 코딩 역량 평가와 에이전트 학습 환경에 대한 기술적 진보가 관찰되었습니다.

### 오늘의 핵심 포인트
- ByteDance의 any-to-any 모델 'Lance' 및 Tencent의 번역 특화 모델(Hy-MT2 시리즈)이 Hugging Face 트렌딩 모델로 부상
- SWE-bench의 새로운 벤치마크 'CodeClash' 공개 및 'mini-SWE-agent'의 높은 효율성 입증
- LiveCodeBench를 통한 최신 모델(O4-Mini, Gemini 시리즈)의 코딩 성능 스냅샷 업데이트

**오늘의 태그**: HuggingFace, SWE-bench, LiveCodeBench, AI Agents, LLM Evaluation

## 1. [bytedance-research/Lance](https://huggingface.co/bytedance-research/Lance)
**Source**: HF Model Trending | **Signal Type**: model_trending | **Category**: Model Trending

### 요약
ByteDance Research에서 공개한 any-to-any 모델인 Lance가 Hugging Face에서 주목받고 있습니다. 해당 모델은 높은 다운로드 수와 좋아요를 기록하며 트렌딩 모델로 부상했습니다.

### 핵심 포인트
- ByteDance Research에서 개발한 Lance 모델 공개
- any-to-any 파이프라인 태그를 가진 모델
- likes 634회, downloads 1001회를 기록하며 트렌딩 중

**태그**: ByteDance, Lance, any-to-any

**Metrics**: {"likes": 634, "downloads": 1001, "num_parameters": 0, "pipeline_tag": "any-to-any"}

### 원문 설명
likes=634, downloads=1001, pipeline_tag=any-to-any

---

## 2. [tencent/Hy-MT2-30B-A3B](https://huggingface.co/tencent/Hy-MT2-30B-A3B)
**Source**: HF Model Trending | **Signal Type**: model_trending | **Category**: Model Trending

### 요약
Tencent에서 공개한 Hy-MT2-30B-A3B 모델이 Hugging Face에서 주목받고 있습니다. 이 모델은 30B 규모의 파라미터를 가진 번역 특화 모델입니다.

### 핵심 포인트
- Tencent에서 개발한 30B 규모의 모델
- 주요 기능은 translation(번역) 작업 수행
- 최근 likes 176회, downloads 224회를 기록하며 트렌딩 중

**태그**: Tencent, Hy-MT2-30B-A3B, translation

**Metrics**: {"likes": 176, "downloads": 224, "num_parameters": 30064725888, "pipeline_tag": "translation"}

### 원문 설명
likes=176, downloads=224, pipeline_tag=translation
...
### 요약
Tencent에서 공개한 1.8B 규모의 translation 특화 모델인 Hy-MT2-1.8B가 Hugging Face에서 주목받고 있습니다. 해당 모델은 약 20억 개의 파라미터를 보유하고 있으며 번역 작업에 최적화되어 있습니다.

### 핵심 포인트
- Tencent에서 개발한 1.8B 규모의 translation 모델
- 268개의 likes와 564회의 downloads를 기록하며 트렌딩 중
- 약 2.04B 파라미터를 가진 경량급 번역 모델

**태그**: Tencent, Hy-MT2-1.8B, translation

**Metrics**: {"likes": 268, "downloads": 564, "num_parameters": 2038515712, "pipeline_tag": "translation"}

### 원문 설명
likes=268, downloads=564, pipeline_tag=translation
