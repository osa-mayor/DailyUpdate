# Model & Eval Signals (2026-08-02)

## 오늘의 요약
DeepSeek 및 Qwen 계열의 고성능 모델들이 Hugging Face에서 높은 관심을 받고 있으며, SWE-bench와 LiveCodeBench를 중심으로 소프트웨어 엔지니어링 및 코딩 역량 평가 체계가 고도화되고 있습니다.

### 오늘의 핵심 포인트
- DeepSeek-V4-Flash 및 Qwen3.6 기반 모델들이 GGUF 포맷 등으로 배포되며 높은 다운로드 수를 기록 중
- SWE-bench 팀이 목표 지향적 개발자 역량 측정을 위한 새로운 벤치마크 'CodeClash'를 도입하고, 에이전트 학습 도구인 'SWE-smith'를 출시
- LiveCodeBench에서 O4-Mini 및 Gemini 시리즈 모델들이 상위권 성적을 기록하며 코딩 성능 경쟁 가속화
...
### 핵심 포인트
- unsloth에서 배포한 DeepSeek-V4-Flash-0731-GGUF 모델의 트렌드 확인
- 4,048회의 downloads와 268개의 likes를 기록하며 사용자 관심을 받음
- 약 284B 규모의 파라미터를 가진 모델로 확인됨

**태그**: DeepSeek-V4-Flash-0731-GGUF, unsloth, GGUF

**Metrics**: {"likes": 268, "downloads": 4048, "num_parameters": 284334567511, "pipeline_tag": ""}

### 원문 설명
likes=268, downloads=4048, pipeline_tag=
...
### 핵심 포인트
- DeepSeek-V4-Flash-0731 모델의 높은 사용자 관심도 확인
- 15,366회의 downloads와 1,377회의 likes 기록
- 약 304B 규모의 파라미터를 가진 text-generation 모델

**태그**: DeepSeek-V4-Flash-0731, text-generation, Hugging Face

**Metrics**: {"likes": 1377, "downloads": 15366, "num_parameters": 304180418494, "pipeline_tag": "text-generation"}

### 원문 설명
likes=1377, downloads=15366, pipeline_tag=text-generation
...
### 핵심 포인트
- 모델명: DavidAU/Qwen3.6-27B-Fable-Fusion-711-Uncensored-Heretic-NM-DAU-NEO-MAX-MTP-GGUF
- 누적 다운로드 수 1,173,001회를 기록하며 높은 관심을 받고 있음
- pipeline_tag는 image-text-to-text이며, 약 26.9B 파라미터를 보유함

**태그**: Qwen3.6, GGUF, image-text-to-text

**Metrics**: {"likes": 1225, "downloads": 1173001, "num_parameters": 26895998464, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=1225, downloads=1173001, pipeline_tag=image-text-to-text
