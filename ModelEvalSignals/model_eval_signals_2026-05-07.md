# Model & Eval Signals (2026-05-07)

## 오늘의 요약
Hugging Face를 중심으로 대규모 언어 모델(LLM)의 트렌딩이 지속되는 가운데, 소프트웨어 엔지니어링 에이전트 역량을 평가하고 학습시키기 위한 새로운 벤치마크(CodeClash, SWE-smith)와 평가 리포트(METR)가 주요 흐름을 형성하고 있습니다.

### 오늘의 핵심 포인트
- DeepSeek-V4-Pro 등 대규모 파라미터 모델 및 비디오 생성 모델의 Hugging Face 트렌딩
- CodeClash, SWE-smith 등 목표 지향적 개발 역량 및 에이전트 학습을 위한 새로운 벤치마크 등장
- METR를 통한 GPT-5, DeepSeek, Qwen 등 주요 모델에 대한 심층 평가 리포트 발표
...
### 요약
DeepSeek-AI에서 공개한 DeepSeek-V4-Pro 모델이 Hugging Face에서 높은 관심을 받고 있습니다. 약 861.6B 규모의 파라미터를 가진 text-generation 모델로, 높은 다운로드 수를 기록하며 트렌딩 모델로 부상했습니다.

### 핵심 포인트
- DeepSeek-AI의 text-generation 모델인 DeepSeek-V4-Pro가 트렌딩 중입니다.
- 약 861.6B(861,608,274,846) 규모의 파라미터를 보유하고 있습니다.
- 786,631회의 다운로드와 3,648개의 likes를 기록하며 높은 활용도를 보이고 있습니다.

**태그**: DeepSeek-V4-Pro, text-generation, Hugging Face

**Metrics**: {"likes": 3648, "downloads": 786631, "num_parameters": 861608274846, "pipeline_tag": "text-generation"}

### 원문 설명
likes=3648, downloads=786631, pipeline_tag=text-generation
...
- 55,461회의 높은 downloads를 기록하며 사용자들의 관심을 받고 있습니다.
- 모델의 파라미터 규모는 약 8.95B입니다.

**태그**: Sulphur-2-base, text-to-video, Hugging Face

**Metrics**: {"likes": 287, "downloads": 55461, "num_parameters": 8953803264, "pipeline_tag": "text-to-video"}

### 원문 설명
likes=287, downloads=55461, pipeline_tag=text-to-video

---

## 3. [TenStrip/LTX2.3-10Eros](https://huggingface.co/TenStrip/LTX2.3-10Eros)
**Source**: HF Model Trending | **Signal Type**: model_trending | **Category**: Model Trending

### 요약
TenStrip/LTX2.3-10Eros 모델이 Hugging Face에서 새롭게 트렌딩되었습니다. 현재 123개의 likes를 기록하며 사용자들의 관심을 받고 있습니다.

### 핵심 포인트
- TenStrip/LTX2.3-10Eros 모델의 트렌딩 발생
- 123개의 likes를 기록하며 초기 관심도 확보
- 현재 다운로드 수 및 파라미터 정보는 제공되지 않음

**태그**: TenStrip/LTX2.3-10Eros, Model Trending, Hugging Face

**Metrics**: {"likes": 123, "downloads": 0, "num_parameters": 0, "pipeline_tag": ""}

### 원문 설명
likes=123, downloads=0, pipeline_tag=
