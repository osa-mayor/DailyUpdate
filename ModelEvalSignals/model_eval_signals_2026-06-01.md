# Model & Eval Signals (2026-06-01)

## 오늘의 요약
Hugging Face를 중심으로 한 새로운 멀티모달 및 텍스트 생성 모델의 등장과 함께, 소프트웨어 엔지니어링 에이전트의 역량을 측정하기 위한 새로운 벤치마크(CodeClash, SWE-smith) 및 코드 생성 성능 평가(LiveCodeBench)가 주요 흐름으로 나타났습니다.

### 오늘의 핵심 포인트
- LiquidAI, Stepfun-ai, ByteDance 등 주요 기업의 새로운 멀티모달 및 텍스트 생성 모델 공개
- 단순 작업 수행을 넘어 목표 지향적 개발 역량을 평가하는 CodeClash 및 에이전트 학습 환경 SWE-smith 등장
- mini-SWE-agent의 효율적인 성능 기록 및 LiveCodeBench를 통한 최신 모델들의 코드 생성 능력 검증

**오늘의 태그**: Multimodal, AI Agents, Software Engineering Benchmark, Code Generation

## 1. [LiquidAI/LFM2.5-8B-A1B](https://huggingface.co/LiquidAI/LFM2.5-8B-A1B)
**Source**: HF Model Trending | **Signal Type**: model_trending | **Category**: Model Trending

### 요약
LiquidAI에서 공개한 8B 규모의 text-generation 모델인 LFM2.5-8B-A1B가 Hugging Face에서 주목받고 있습니다. 약 2.7만 건의 다운로드와 312개의 likes를 기록하며 높은 관심을 받고 있습니다.

### 핵심 포인트
- LiquidAI에서 출시한 8B 파라미터 규모의 text-generation 모델
- Hugging Face에서 27,677회의 다운로드를 기록하며 트렌딩 중
- 모델 파라미터 수는 약 8.47B 수준임

**태그**: LiquidAI, LFM2.5-8B-A1B, text-generation

**Metrics**: {"likes": 312, "downloads": 27677, "num_parameters": 8467856832, "pipeline_tag": "text-generation"}

### 원문 설명
likes=312, downloads=27677, pipeline_tag=text-generation
...
**태그**: Step-3.7-Flash, Multimodal, Hugging Face

**Metrics**: {"likes": 158, "downloads": 7638, "num_parameters": 201365316160, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=158, downloads=7638, pipeline_tag=image-text-to-text
...
- likes 990회, downloads 2,948회를 기록하며 트렌딩 중

**태그**: ByteDance, Lance, any-to-any

**Metrics**: {"likes": 990, "downloads": 2948, "num_parameters": 0, "pipeline_tag": "any-to-any"}

### 원문 설명
likes=990, downloads=2948, pipeline_tag=any-to-any
