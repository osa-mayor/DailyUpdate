# Model & Eval Signals (2026-06-29)

## 오늘의 요약
Hugging Face의 신규 모델 트렌드와 소프트웨어 엔지니어링 및 코딩 역량 평가를 위한 새로운 벤치마크/에이전트 기술이 주요 흐름을 형성하고 있습니다.

### 오늘의 핵심 포인트
- empero-ai의 Qwythos-9B 및 Baidu의 Unlimited-OCR 등 특정 태스크(이미지-텍스트, OCR)에 특화된 모델들이 주목받고 있습니다.
- SWE-bench 팀에서 목표 지향적 개발 역량 측정을 위한 CodeClash를 공개하고, 에이전트 학습 도구인 SWE-smith를 출시하는 등 AI 에이전트 평가 및 학습 환경이 고도화되고 있습니다.
- LiveCodeBench를 통해 Gemini 및 O4-Mini 등 최신 모델들의 코딩 성능(pass@1) 경쟁이 지속되고 있습니다.

**오늘의 태그**: LLM, AI Agent, Benchmark, Coding, Software Engineering
...
### 핵심 포인트
- 83만 회 이상의 높은 downloads를 기록하며 트렌딩 중
...
**Metrics**: {"likes": 755, "downloads": 831529, "num_parameters": 8953803264, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=755, downloads=831529, pipeline_tag=image-text-to-text
...
### 핵심 포인트
- empero-ai의 9.4B 파라미터 규모 text-generation 모델
- 52,492회의 높은 다운로드 수를 기록하며 트렌딩 중
- 518개의 likes를 확보하며 사용자 관심을 반영

**태그**: Qwythos-9B-Claude-Mythos-5-1M, text-generation, Hugging Face

**Metrics**: {"likes": 518, "downloads": 52492, "num_parameters": 9409813744, "pipeline_tag": "text-generation"}

### 원문 설명
likes=518, downloads=52492, pipeline_tag=text-generation
...
- 약 29만 회 이상의 높은 다운로드 수 기록
- image-text-to-text 파이프라인을 활용한 OCR 작업 수행

**태그**: Baidu, Unlimited-OCR, OCR

**Metrics**: {"likes": 1212, "downloads": 295064, "num_parameters": 3336106240, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=1212, downloads=295064, pipeline_tag=image-text-to-text
