...
### 오늘의 핵심 포인트
- MiniMax-H3 모델이 Hugging Face에서 높은 다운로드와 함께 비디오 생성 파이프라인 기능으로 주목받음
- Qwen3.6 기반 GGUF 양자화 모델이 높은 사용성을 기록하며 텍스트 생성 성능 입증
- LiveCodeBench 벤치마크에서 O4-Mini 및 Gemini 시리즈 모델들이 상위권 성적 기록

**오늘의 태그**: HuggingFace, LiveCodeBench, MiniMax-H3, Qwen3.6, Gemini
...
### 핵심 포인트
- Comfy-Org의 MiniMax-H3 모델이 Hugging Face에서 트렌딩 중입니다.
- 누적 다운로드 수가 4,947,943회를 기록하며 높은 인기를 얻고 있습니다.
- 1,060개의 likes를 기록하며 사용자들의 관심을 받고 있습니다.

**태그**: MiniMax-H3, Comfy-Org, Hugging Face

**Metrics**: {"likes": 1060, "downloads": 4947943, "num_parameters": 0, "pipeline_tag": ""}

### 원문 설명
likes=1060, downloads=4947943, pipeline_tag=
...
- 35,295회의 다운로드와 3,217개의 likes를 기록하며 트렌딩 중입니다.

**태그**: MiniMax-H3, image-text-to-video, MiniMaxAI

**Metrics**: {"likes": 3217, "downloads": 35295, "num_parameters": 33122992896, "pipeline_tag": "image-text-to-video"}

### 원문 설명
likes=3217, downloads=35295, pipeline_tag=image-text-to-video
...
- 약 239만 회 이상의 다운로드와 1,800개의 likes를 기록하며 높은 관심을 받고 있습니다.
- pipeline_tag는 image-text-to-text로 분류됩니다.

**태그**: Qwen3.6, GGUF, image-text-to-text

**Metrics**: {"likes": 1800, "downloads": 2390692, "num_parameters": 26895998464, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=1800, downloads=2390692, pipeline_tag=image-text-to-text
