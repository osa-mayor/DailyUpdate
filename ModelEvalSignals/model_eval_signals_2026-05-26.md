...
- SWE-bench를 통해 목표 지향적 개발 역량 평가(CodeClash) 및 에이전트 학습 환경(SWE-smith) 등 소프트웨어 엔지니어링 에이전트 기술 고도화
- LiveCodeBench를 통해 Gemini 시리즈 등 최신 모델들의 코딩 성능(avg_pass@1) 경쟁 및 벤치마크 스냅샷 업데이트

**오늘의 태그**: Multimodal, Software Engineering Agents, Coding Benchmark, LLM Trends
...
- likes 812회, downloads 1,679회를 기록하며 사용자들의 관심을 받고 있습니다.

**태그**: ByteDance, Lance, any-to-any

**Metrics**: {"likes": 812, "downloads": 1679, "num_parameters": 0, "pipeline_tag": "any-to-any"}

### 원문 설명
likes=812, downloads=1679, pipeline_tag=any-to-any
...
- 7,449회의 다운로드와 198개의 likes를 기록하며 트렌딩 중

**태그**: CohereLabs, image-text-to-text, LLM

**Metrics**: {"likes": 198, "downloads": 7449, "num_parameters": 125789176144, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=198, downloads=7449, pipeline_tag=image-text-to-text
...
- likes 322회, downloads 1,494회를 기록하며 트렌딩 중

**태그**: Tencent, Hy-MT2-30B-A3B, translation

**Metrics**: {"likes": 322, "downloads": 1494, "num_parameters": 30064725888, "pipeline_tag": "translation"}

### 원문 설명
likes=322, downloads=1494, pipeline_tag=translation
