# Model & Eval Signals (2026-08-06)

## 오늘의 요약
Hugging Face의 신규 모델 공개와 더불어, 소프트웨어 엔지니어링 에이전트 역량 측정을 위한 새로운 벤치마크 및 학습 환경이 등장하며 AI 에이전트 기술의 고도화가 가속화되고 있습니다.

### 오늘의 핵심 포인트
- MiniMax-H3, Qwen3-VL 등 멀티모달 기능을 갖춘 신규 모델들이 Hugging Face에서 주목받으며 다양한 파이프라인 지원
- CodeClash, SWE-smith 등 목표 지향적 개발자 역량 측정 및 에이전트 학습을 위한 전문 벤치마크/도구 등장
- LiveCodeBench를 통해 O4-Mini 및 Gemini 시리즈 등 최신 모델들의 코딩 성능 경쟁 확인

**오늘의 태그**: LLM_Agents, Benchmark_Update, Multimodal_Models, Software_Engineering_AI
...
- 높은 다운로드 수(10,841)와 좋아요(2,462)를 기록하며 트렌드 모델로 부상했습니다.

**태그**: MiniMax-H3, image-text-to-video, MiniMaxAI

**Metrics**: {"likes": 2462, "downloads": 10841, "num_parameters": 33122992896, "pipeline_tag": "image-text-to-video"}

### 원문 설명
likes=2462, downloads=10841, pipeline_tag=image-text-to-video

---

## 2. [ethanfel/Qwen3-VL-32B-Ultra-Heretic-H3-ComfyUI-INT8-ConvRot](https://huggingface.co/ethanfel/Qwen3-VL-32B-Ultra-Heretic-H3-ComfyUI-INT8-ConvRot)
**Source**: HF Model Trending | **Signal Type**: model_trending | **Category**: Model Trending
...
### 핵심 포인트
- ethanfel/Qwen3-VL-32B-Ultra-Heretic-H3-ComfyUI-INT8-ConvRot 모델의 likes가 274를 기록했습니다.
- 해당 모델의 pipeline_tag는 image-text-to-text로 분류됩니다.
- 현재 downloads는 0으로 기록되어 있습니다.

**태그**: Qwen3-VL, image-text-to-text, HuggingFace

**Metrics**: {"likes": 274, "downloads": 0, "num_parameters": 0, "pipeline_tag": "image-text-to-text"}

### 원문 설명
likes=274, downloads=0, pipeline_tag=image-text-to-text
...
- 111,678회의 높은 downloads를 기록하며 사용자들의 높은 관심을 입증
- GGUF 포맷을 통해 양자화된 모델 활용 가능성 제시

**태그**: DeepSeek-V4-Flash-0731-GGUF, unsloth, GGUF

**Metrics**: {"likes": 497, "downloads": 111678, "num_parameters": 284334567511, "pipeline_tag": ""}

### 원문 설명
likes=497, downloads=111678, pipeline_tag=
