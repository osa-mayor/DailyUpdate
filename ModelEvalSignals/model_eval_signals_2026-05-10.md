# Model & Eval Signals (2026-05-10)

## 오늘의 요약
Hugging Face를 중심으로 한 신규 모델(Text-to-Video, Large-scale Text Generation)의 등장과 함께, 소프트웨어 엔지니어링 에이전트의 역량을 측정하고 학습시키기 위한 새로운 벤치마크 및 평가 도구들이 활발히 공개되었습니다.

### 오늘의 핵심 포인트
- Hugging Face 내 고성능 모델(Sulphur-2-base, ZAYA1-8B, MiMo-V2.5-Pro)의 높은 관심 및 다운로드 기록
- SWE-bench 기반의 목표 지향적 개발 역량 평가(CodeClash) 및 에이전트 학습 환경(SWE-smith) 등 소프트웨어 엔지니어링 특화 벤치마크 진화
...
- 누적 다운로드 수가 115,477회를 기록하며 높은 관심을 받고 있습니다.
- 모델의 파라미터 규모는 약 8.95B입니다.

**태그**: Sulphur-2-base, text-to-video, Hugging Face

**Metrics**: {"likes": 484, "downloads": 115477, "num_parameters": 8953803264, "pipeline_tag": "text-to-video"}

### 원문 설명
likes=484, downloads=115477, pipeline_tag=text-to-video
...
### 요약
Zyphra에서 공개한 ZAYA1-8B 모델이 Hugging Face에서 높은 다운로드 수를 기록하며 주목받고 있습니다. 약 8.8B 파라미터를 가진 이 모델은 최근 사용자들의 높은 관심을 받고 있습니다.

### 핵심 포인트
- Zyphra/ZAYA1-8B 모델의 Hugging Face 트렌딩 발생
- 23,620회의 높은 다운로드 수 기록
- 약 8.8B 규모의 파라미터를 보유한 모델

**태그**: Zyphra, ZAYA1-8B, Model Trending

**Metrics**: {"likes": 320, "downloads": 23620, "num_parameters": 8840488784, "pipeline_tag": ""}

### 원문 설명
likes=320, downloads=23620, pipeline_tag=

---

## 3. [XiaomiMiMo/MiMo-V2.5-Pro](https://huggingface.co/XiaomiMiMo/MiMo-V2.5-Pro)
**Source**: HF Model Trending | **Signal Type**: model_trending | **Category**: Model Trending

### 요약
XiaomiMiMo/MiMo-V2.5-Pro 모델이 Hugging Face에서 주목받고 있습니다. 해당 모델은 text-generation 태스크를 위한 모델로, 약 1T 규모의 파라미터를 보유하고 있습니다.

### 핵심 포인트
- XiaomiMiMo/MiMo-V2.5-Pro 모델의 Hugging Face 트렌딩 발생
- 31,447회의 downloads와 497회의 likes를 기록
- 약 1.02T 규모의 파라미터를 가진 text-generation 모델

**태그**: XiaomiMiMo, MiMo-V2.5-Pro, text-generation

**Metrics**: {"likes": 497, "downloads": 31447, "num_parameters": 1023244718976, "pipeline_tag": "text-generation"}

### 원문 설명
likes=497, downloads=31447, pipeline_tag=text-generation
