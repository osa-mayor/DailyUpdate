...
**오늘의 태그**: LLM, AI Agents, Software Engineering, Coding Benchmark, Hugging Face
...
- 12,148회의 다운로드와 447개의 likes를 기록하며 높은 관심을 받음
- 약 3.09B(3,085,938,688)개의 파라미터를 보유

**태그**: WeiboAI, VibeThinker-3B, text-generation

**Metrics**: {"likes": 447, "downloads": 12148, "num_parameters": 3085938688, "pipeline_tag": "text-generation"}

### 원문 설명
likes=447, downloads=12148, pipeline_tag=text-generation
...
- 11,871회의 다운로드와 1,507개의 likes를 기록하며 트렌딩 중
- 약 753B 규모의 파라미터를 가진 text-generation 모델

**태그**: GLM-5.2, text-generation, HuggingFace

**Metrics**: {"likes": 1507, "downloads": 11871, "num_parameters": 753329940480, "pipeline_tag": "text-generation"}

### 원문 설명
likes=1507, downloads=11871, pipeline_tag=text-generation
...
### 핵심 포인트
- 268,102회의 높은 downloads를 기록하며 주목받고 있음
- 1,818개의 likes를 보유한 인기 모델
- 약 11.9B 파라미터를 가진 text-generation용 GGUF 모델

**태그**: gemma-4-12B, GGUF, text-generation

**Metrics**: {"likes": 1818, "downloads": 268102, "num_parameters": 11907350576, "pipeline_tag": "text-generation"}

### 원문 설명
likes=1818, downloads=268102, pipeline_tag=text-generation
