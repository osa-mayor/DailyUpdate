# Official Releases (2026-07-25)

## 오늘의 요약
주요 AI 기업들이 차세대 모델(Gemini 3.6, Claude Opus 5 등) 출시와 함께 에이전트, 보안, 전문 업무 특화 기능을 선보이며 AI의 실질적 활용 영역을 확장하고 있습니다.

### 오늘의 핵심 포인트
- Google DeepMind와 Anthropic의 차세대 모델(Gemini 3.6/3.5, Claude Opus 5) 출시를 통한 성능 고도화
- OpenAI의 Health 및 Presence 출시를 통한 개인 맞춤형 서비스 및 기업용 AI 에이전트 시장 확대
- AI 모델의 전문화(보안, 코딩, 경제 연구, 이미지 생성) 및 기업 업무 자동화 사례(NTT DATA) 증가

**오늘의 태그**: AI Model Release, AI Agent, Generative AI
...
## 3. [Introducing Gemini 3.6 Flash, 3.5 Flash-Lite, and 3.5 Flash Cyber](https://blog.google/innovation-and-ai/models-and-research/gemini-models/gemini-3-6-flash-3-5-flash-lite-3-5-flash-cyber/)
**Source**: Google DeepMind | **Category**: Official Release | **Release Type**: official_update

### 요약
Google DeepMind가 새로운 Gemini 모델 라인업인 Gemini 3.6 Flash, 3.5 Flash-Lite, 3.5 Flash Cyber를 발표했습니다. 이번 발표는 다양한 용도에 맞춘 새로운 Flash 모델들의 출시를 담고 있습니다.
...
**태그**: Google DeepMind, Gemini, AI Model
...
## 4. [Introducing Claude Opus 5 Product Jul 24, 2026 Opus 5 is a step change improvement for the Opus tier powering long-running agents while delivering improvements in coding and professional work.](https://www.anthropic.com/news/claude-opus-5)
...
## 5. [Launching Health in ChatGPT](https://openai.com/index/health-in-chatgpt)
...
## 6. [Introducing OpenAI Presence](https://openai.com/index/introducing-openai-presence)
**Source**: OpenAI News | **Category**: Product | **Release Type**: product_release
...
## 7. [NTT DATA Group cuts incident analysis to 30 minutes with Codex](https://openai.com/index/ntt-data)
**Source**: OpenAI News | **Category**: Official Release | **Release Type**: official_update

### 요약
NTT DATA Group이 ChatGPT Enterprise와 Codex를 도입하여 9,000명의 직원을 대상으로 업무 자동화를 추진합니다. 이를 통해 사고 분석 시간을 30분으로 단축하고 보안이 확보된 AI 도입을 확장하고 있습니다.

### 핵심 포인트
- NTT DATA Group의 ChatGPT Enterprise 및 Codex 도입
- 9,000명의 직원을 대상으로 한 업무 자동화 구현
- 사고 분석 시간을 30분으로 단축 및 보안 중심의 AI 확장

**태그**: NTT DATA Group, ChatGPT Enterprise, Codex
...
## 8. [Jul 22, 2026 Economic Research A research agenda for the Economic Futures Research Fund](https://www.anthropic.com/news/economic-futures-research-fund-agenda)
**Source**: Anthropic News | **Category**: Research | **Release Type**: research_release

### 요약
Anthropic이 경제적 미래를 연구하기 위한 Economic Futures Research Fund의 연구 의제를 발표했습니다. 이 펀드는 경제적 변화에 대응하는 연구 과제를 설정하는 데 목적이 있습니다.

### 핵심 포인트
- Economic Futures Research Fund의 연구 의제 공개
- 경제적 미래를 위한 연구 과제 설정
- 경제적 변화에 대한 연구 중심의 접근

**태그**: Anthropic, Economic Research, Research Agenda

---

## 9. [Jul 22, 2026 Product Ask Claude about the Anthropic Economic Index](https://www.anthropic.com/news/anthropic-economic-index-connector)
**Source**: Anthropic News | **Category**: Product | **Release Type**: product_release

### 요약
Anthropic이 새로운 제품 기능을 통해 사용자가 Anthropic Economic Index에 대해 질문할 수 있도록 지원합니다. 이를 통해 경제 지표와 관련된 정보를 Claude를 통해 확인할 수 있습니다.

### 핵심 포인트
- Claude를 통해 Anthropic Economic Index에 대한 질의 가능
- 새로운 제품 기능 출시

**태그**: Anthropic, Claude, Economic Index
...
## 13. [Google named a Leader in the 2026 IDC MarketScape for Worldwide Foundation Model Software](https://cloud.google.com/blog/products/ai-machine-learning/google-named-a-leader-in-idc-marketscape)
**Source**: Google Cloud AI | **Category**: AI & Machine Learning | **Release Type**: engineering_update
